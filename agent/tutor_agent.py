...
_INSTRUCTIONS = (
    ...
    "REGLAS DE OPERACIÓN:\n"
    "1. Herramienta de Indexación: Usa `index_v2` tanto para solicitudes de indexación integral completa como para procesar elementos de forma independiente (ej. solo un observatorio, solo un datasource o catálogos).\n"
    ...
    "4. Flexibilidad de Parámetros: `index_v2` es flexible y acepta parámetros opcionales. Si el usuario solo quiere crear un observatorio o un datasource por separado, ejecuta la herramienta con los datos proporcionados sin exigir campos obligatorios sobrantes.\n"
    "5. Tipos de Datos (CRÍTICO): Envía TODOS los parámetros como texto (cadenas/strings). Parámetros como `start_year` y `end_year` deben ir estrictamente entre comillas (ej. '2000', no 2000).\n"
    "6. Archivos Adjuntos: Extrae el nombre del archivo principal adjunto o mencionado (ej. emisiones_benceno.csv) y asígnalo al parámetro `csv_filename`.\n"
