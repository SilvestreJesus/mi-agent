        ...
        for f in file:
            if f.filename: 
                ...
                if ext in IMAGE_EXTENSIONS:
                    ...
                    file_info_list.append(f"[Imagen adjunta guardada con éxito en '/app/images/{f.filename}'. Usa 'product_file_filename=\"{f.filename}\"' para la herramienta 'pipeline_integral_jub_v2']")
                ...
                # Si el archivo es un CSV u otro tipo de documento de datos
                    ...
                    file_info_list.append(f"[Archivo CSV guardado exitosamente en '/app/sources/{f.filename}'. Usa 'csv_path=\"{f.filename}\"' para 'convertir_csv_a_json' o 'csv_filename=\"{f.filename}\"' para 'pipeline_integral_jub_v2']")
